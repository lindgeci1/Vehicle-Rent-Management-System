...
namespace VRMS.Infrastructure.Migrations
{
    ...
    [Migration("20250521114829_RelationsBetweenPaymentReservation")]
    partial class RelationsBetweenPaymentReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Photo", b =>
                {
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.TripDetails", b =>
                {
                    b.Property<int>("TripDetailsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TripDetailsId"));
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.VehicleGpsHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VehicleGpsHistories");
                });

            modelBuilder.Entity("VRMS.Domain.Entities.VerificationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Bus", b =>
                {
                    b.HasBaseType("VRMS.Domain.Entities.Vehicle");

                    b.Property<bool>("HasLuggageCompartment")
                        .HasColumnType("bit");

                    b.Property<bool>("HasToilet")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDoubleDecker")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Car", b =>
                {
                    b.HasBaseType("VRMS.Domain.Entities.Vehicle");
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Motorcycle", b =>
                {
                    b.HasBaseType("VRMS.Domain.Entities.Vehicle");
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Truck", b =>
                {
                    b.HasBaseType("VRMS.Domain.Entities.Vehicle");
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Bus", b =>
                {
                    b.HasOne("VRMS.Domain.Entities.Vehicle", null)
                        .WithOne()
                        .HasForeignKey("VRMS.Domain.Entities.Bus", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Car", b =>
                {
                    b.HasOne("VRMS.Domain.Entities.Vehicle", null)
                        .WithOne()
                        .HasForeignKey("VRMS.Domain.Entities.Car", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Motorcycle", b =>
                {
                    b.HasOne("VRMS.Domain.Entities.Vehicle", null)
                        .WithOne()
                        .HasForeignKey("VRMS.Domain.Entities.Motorcycle", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VRMS.Domain.Entities.Truck", b =>
                {
                    b.HasOne("VRMS.Domain.Entities.Vehicle", null)
                        .WithOne()
                        .HasForeignKey("VRMS.Domain.Entities.Truck", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
