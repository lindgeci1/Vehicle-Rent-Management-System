...
import {
  ...
  Typography, Box, Button, Divider, Grid, Tooltip, IconButton
} from '@mui/material';
import {
...
const MotorcycleDialog = ({ open, onClose, vehicle, startDate, endDate }) => {
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers sx={{ pt: 2 }}>
        {vehicle ? (
          <>
            ...
            <Box sx={{ backgroundColor: '#f9f9f9', p: 2, borderRadius: 2, border: '1px solid #e0e0e0' }}>
              <Grid container spacing={2}>
                ...
                <InfoItem label="Navigation:" value={renderYesNoIcon(vehicle.hasNavigationSystem)} icon={<Navigation />} />
                <InfoItem label="Electric:" value={renderYesNoIcon(vehicle.isElectric)} />
                <InfoItem label="ABS:" value={renderYesNoIcon(vehicle.hasABS)} />
                <InfoItem label="Side Car:" value={renderYesNoIcon(vehicle.hasSideCar)} />
              </Grid>
            </Box>
          ...
          <Typography variant="body2">Loading motorcycle details...</Typography>
        )}
      </DialogContent>
