...
import {
  ...
  Typography, Box, Button, Divider, Grid, Tooltip, IconButton, CardMedia
} from '@mui/material';
import {
...
<Grid item xs={6}>
  <Typography variant="body2" fontWeight={600}>Electric:</Typography>
...
<Grid item xs={6}>
  <Typography variant="body2" fontWeight={600}>ABS:</Typography>
  <Typography variant="body2" color="text.secondary">
    {vehicle.hasABS ? 'Yes' : 'No'}
  </Typography>
</Grid>

<Grid item xs={6}>
  <Typography variant="body2" fontWeight={600}>Side Car:</Typography>
  <Typography variant="body2" color="text.secondary">
    {vehicle.hasSideCar ? 'Yes' : 'No'}
  </Typography>
</Grid>

<Grid item xs={6}>
  <Typography variant="body2" fontWeight={600}>Max Speed:</Typography>
  <Typography variant="body2" color="text.secondary">
